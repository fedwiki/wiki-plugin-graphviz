...
(function () {
  ...
  describe("graphviz plugin", () => {
    ...
    describe("authors can convert algorithmic diagrams into static diagrams", () => {
      describe("when text omits both DOT and STATIC", () => {
        // static diagram
        const item = {
          type: "graphviz",
      ...
      describe("when text contains DOT and omits STATIC", () => {
        // algorithmic diagram
        const item = {
          type: "graphviz",
...
"Welcome Visitors"->"Local Changes"
      ...
      describe("when text contains both DOT and STATIC", () => {
...
"Welcome Visitors"->"Local Changes"
      ...
      describe("when text omits DOT and contains STATIC", () => {
        const item = {
          type: "graphviz",
          text: `STATIC
...
strict digraph { A -> B -> C}`,
    ...
    describe("cleanBeforeMakedot()", () => {
      describe("when text contains DOT and STATIC", () => {
        const item = {
          type: "graphviz",
          text: `DOT FROM about-graphviz-plugin
